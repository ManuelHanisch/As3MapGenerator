...
/**
 * 
 * Manuel Hanisch: took NoisyEdges from amitp and change to my needs
 * Link: https://github.com/amitp/mapgen2/blob/master/NoisyEdges.as
 * 
 */
...
package de.mime.rw.world.mapData {
  ...
  public class NoisyEdges {
    ...
    public function buildNoisyEdges(grid:Grid, random:PM_PRNG):void {
		
      var p:Center, edge:Edge;
	  
      for each (p in grid.voimap.centers) {
